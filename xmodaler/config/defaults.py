...
_C.DATALOADER.REG_PER_SAMPLE = 3
...
_C.MODEL.GIVENBGT = False

_C.MODEL.DEVICE = "cuda"

_C.MODEL.VOCAB_SIZE = 1000 # include <BOS>/<EOS>

_C.MODEL.BBOX_SIZE = 1000 # include <BOS>/<EOS>
...
_C.MODEL.MULTIPERSPECTIVE_COUNT = ''

_C.MODEL.MULTIPERSPECTIVE_MAPS_PREDICTION = ''

_C.MODEL.BBOX_PREDICTOR = ''

_C.MODEL.PREDICTOR_BBOX = ''
...
_C.MODEL.TOKEN_EMBED_BBOX = CN()

_C.MODEL.TOKEN_EMBED_BBOX.NAME = ''

_C.MODEL.TOKEN_EMBED_BBOX.DIM = 1024

_C.MODEL.TOKEN_EMBED_BBOX.ACTIVATION = 'none'

_C.MODEL.TOKEN_EMBED_BBOX.ELU_ALPHA = 0.5

_C.MODEL.TOKEN_EMBED_BBOX.USE_NORM = False

_C.MODEL.TOKEN_EMBED_BBOX.DROPOUT = 0.0

_C.MODEL.TOKEN_EMBED_BBOX.POSITION = 'none'

_C.MODEL.TOKEN_EMBED_BBOX.POSITION_MAX_LEN = 5000

_C.MODEL.TOKEN_EMBED_BBOX.TYPE_VOCAB_SIZE = 0
# ----------------------------------------------------------------------------
# Visual embedding
# ----------------------------------------------------------------------------
_C.MODEL.MP_COUNT = CN()
_C.MODEL.MP_COUNT.NUM = 4
...
_C.INFERENCE.DETBBOX = 'loc_vocabulary.txt'

_C.INFERENCE.ID_KEY = 'image_id'

_C.INFERENCE.B_ID_KEY = 'region_id'
